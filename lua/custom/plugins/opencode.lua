return {
  ...
  config = function()
    require('opencode').setup {
      ...
      default_system_prompt = 'Ignore the "tmp" folder at all time if it exists', -- Custom system prompt to use for all sessions. If nil, uses the default built-in system prompt
